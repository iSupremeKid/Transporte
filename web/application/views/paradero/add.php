    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Agregar paradero</h3>
            </div>
            <?php echo form_open('paradero/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="latitud" value="<?php echo $this->input->post('latitud'); ?>" class="form-control" id="latitud" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="longitud" value="<?php echo $this->input->post('longitud'); ?>" class="form-control" id="longitud" />
