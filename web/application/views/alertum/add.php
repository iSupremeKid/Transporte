    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Agregar alerta</h3>
            </div>
            <?php echo form_open('alertum/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						<label for="tipo_alerta_id" class="control-label"><span class="text-danger">*</span>Tipo de alerta</label>
						<div class="form-group">
							<select name="tipo_alerta_id" class="form-control">
								...
								{
									$selected = ($tipo_alertum['id'] == $this->input->post('tipo_alerta_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="mensaje" value="<?php echo $this->input->post('mensaje'); ?>" class="form-control" id="mensaje" />
